                ...
                <section class="mb-50">
                    <div class="row mb-60">
                        <div class="col-md-4 mb-4 mb-md-0">
                            ...
                            <abbr title="Email">Email: </abbr><a href="http://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d7b4b8b9a3b6b4a39792a1b6a5b6f9b4b8ba">[email&#160;protected]</a><br />
                        ...
                        <div class="col-md-4 mb-4 mb-md-0">
                            ...
                            Chicago, 60601, USA<br />
                            <abbr title="Phone">Phone:</abbr> (123) 456-7890<br />
                            <abbr title="Email">Email: </abbr><a href="http://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c8aba7a6bca9abbc888dbea9baa9e6aba7a5">[email&#160;protected]</a><br />
                            <a class="btn btn-sm font-weight-bold text-white mt-20 border-radius-5 btn-shadow-brand hover-up"><i class="fi-rs-marker mr-5"></i>View map</a>
                        </div>
                        <div class="col-md-4">
                            ...
                            Chicago, 60601, USA<br />
                            <abbr title="Phone">Phone:</abbr> (123) 456-7890<br />
                            <abbr title="Email">Email: </abbr><a href="http://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="43202c2d372220370306352231226d202c2e">[email&#160;protected]</a><br />
                            <a class="btn btn-sm font-weight-bold text-white mt-20 border-radius-5 btn-shadow-brand hover-up"><i class="fi-rs-marker mr-5"></i>View map</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="contact-from-area padding-20-row-col">
                                ...
                                <form class="contact-form-style mt-30" id="contact-form" action="{{ action('App\Http\Controllers\ContactForm@contactform') }}" method="post">
                                    @csrf
                                    <div class="row">
                        ...
                        <div class="col-lg-4 pl-50 d-lg-block d-none">
                            <img class="border-radius-15 mt-50" src="{{ asset ('imgs/page/contact-2.png') }}" alt="" />
                        </div>
                    </div>
                </section>
            </div>
