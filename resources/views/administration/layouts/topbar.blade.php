    ...
    <nav class="navbar navbar-static-top navbar-expand-lg">
        ...
        <div class="search-form d-lg-inline-block">
            <div class="input-group">
                <input name="query" id="search-input" class="form-control" placeholder="search.."  autocomplete="off">
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right ec-dropdown-menu">
                        ...
                        <li>
                            <a href="{{ route('admin.detail.utilisateurs' , ['id_utilisateur' => 1]) }}"> <i class="mdi mdi-account"></i> My Profile</a>
                        </li>
                        <li>
                        ...
                        <li class="dropdown-footer">
                            <a href="{{ route('accueil') }}"><i class="mdi mdi-logout"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
                                    ...
                                    <ul class="list-unstyled" data-simplebar style="height:360px">
                                        ...
                                        <li>
                                            <a href="javscript:void(0)" class="media media-message media-notification">
                                                <div class="position-relative mr-3">
                                                    <img class="rounded-circle" src="{{ asset ('admin/img/user/u2.jpg') }}" alt="Image">
                                        ...
                                        <li>
                                            <a href="javscript:void(0)" class="media media-message media-notification media-active">
                                                <div class="position-relative mr-3">
                                                    <img class="rounded-circle" src="{{ asset ('admin/img/user/u1.jpg') }}" alt="Image">
                                        ...
                                        <li>
                                            <a href="javscript:void(0)" class="media media-message media-notification">
                                                <div class="position-relative mr-3">
                                                    <img class="rounded-circle" src="{{ asset ('admin/img/user/u5.jpg') }}" alt="Image">
                                                    <span class="status away"></span>
                                                </div>
                                                <div class="media-body d-flex justify-content-between">
                                                    <div class="message-contents">
                                            ...
                                            <a href="javscript:void(0)" class="media media-message media-notification">
                                                ...
                                                <div class="media-body d-flex justify-content-between">
                                                    <div class="message-contents">
                                                        ...
                                                        <span class="my-1 btn btn-sm btn-success">Accept</span> <span class="my-1 btn btn-sm btn-secondary">Delete</span> <span class="font-size-12 font-weight-medium text-secondary d-block">
                                ...
                                <div class="tab-pane fade" id="profile2" role="tabpanel">
                                    <ul class="list-unstyled" data-simplebar style="height:360px">
                                        ...
                                        <li>
                                            <a href="javscript:void(0)" class="media media-message media-notification">
                                                <div class="position-relative mr-3">
                                                    <img class="rounded-circle" src="{{ asset ('admin/img/user/u6.jpg') }}" alt="Image">
                                                    <span class="status away"></span>
                                                </div>
                                                <div class="media-body d-flex justify-content-between">
                                                    <div class="message-contents">
                                        ...
                                        <li>
                                            <a href="javscript:void(0)" class="media media-message media-notification">
                                                <div class="position-relative mr-3">
                                                    <img class="rounded-circle" src="{{ asset ('admin/img/user/u7.jpg') }}" alt="Image">
                                                    <span class="status away"></span>
                                                </div>
                                                <div class="media-body d-flex justify-content-between">
                                                    <div class="message-contents">
