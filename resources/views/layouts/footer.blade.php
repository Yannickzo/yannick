            ...
            <div class="row">
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="logo mb-30">
                            <a href="{{ route('accueil') }}" class="mb-15"><img src="{{ asset('imgs/theme/logo.svg') }}" alt="logo" /></a>
                        ...
                        <ul class="contact-infor">
                            ...
                            <li><img src="{{ asset('imgs/theme/icons/icon-email-2.svg') }}" alt="" /><strong>Email:</strong><span><a href="">[email&#160;protected]</a></span></li>
                            <li><img src="{{ asset('imgs/theme/icons/icon-clock.svg') }}" alt="" /><strong>Hours:</strong><span>10:00 - 18:00, Mon - Sat</span></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="footer-link-widget widget-install-app col wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                    ...
                    <div class="download-app">
                        <a href="#" class="hover-up mb-sm-2 mb-lg-0"><img class="active" src="{{ asset('imgs/theme/app-store.jpg') }}" alt="" /></a>
                        <a href="#" class="hover-up mb-sm-2"><img src="{{ asset('imgs/theme/google-play.jpg') }}" alt="" /></a>
                    </div>
                    <p class="mb-20">Secured Payment Gateways</p>
                    <img class="" src="{{ asset('imgs/theme/payment-method.png') }}" alt="" />
                </div>
            </div>
    </section>
