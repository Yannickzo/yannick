                    ...
                    <div class="product-cart-wrap mb-30">
                        <div class="product-img-action-wrap">
                            ...
                            <div class="product-action-1">
                                <a aria-label="Add To Wishlist" class="action-btn" href="{{ route ('liste_souhait') }}"><i class="fi-rs-heart"></i></a>
                        ...
                        <div class="product-content-wrap">
                            ...
                            <div>
                                <span class="font-small text-muted">By <a href="{{ route ('singleVendor' , ['vendeur_id'=>1]) }}">NestFood</a></span>
                            </div>
                ...
                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30">
                        ...
                        <div class="product-content-wrap">
                            ...
                            <div>
                                <span class="font-small text-muted">By <a href="{{ route ('singleVendor' , ['vendeur_id'=>1]) }}">Stouffer</a></span>
                            </div>
                            <div class="product-card-bottom">
                                <div class="product-price">
                                    <span>$52.85</span>
                ...
                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30">
                        ...
                        <div class="product-content-wrap">
                            ...
                            <div>
                                <span class="font-small text-muted">By <a href="{{ route ('singleVendor' , ['vendeur_id'=>1]) }}">StarKist</a></span>
                            </div>
                            <div class="product-card-bottom">
                                <div class="product-price">
                                    <span>$48.85</span>
                ...
                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30">
                        ...
                        <div class="product-content-wrap">
                            ...
                            <div>
                                <span class="font-small text-muted">By <a href="{{ route ('singleVendor' , ['vendeur_id'=>1]) }}">Old El Paso</a></span>
                            </div>
                            <div class="product-card-bottom">
                                <div class="product-price">
                                    <span>$23.85</span>
                ...
                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-none d-xl-block">
                    <div class="product-cart-wrap mb-30">
                        ...
                        <div class="product-content-wrap">
                            ...
                            <div>
                                <span class="font-small text-muted">By <a href="{{ route ('singleVendor' , ['vendeur_id'=>1]) }}">Tyson</a></span>
                            </div>
                            <div class="product-card-bottom">
                                <div class="product-price">
                                    <span>$22.85</span>
                        ...
                        <div class="product-cart-wrap style-2">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="deals-content">
                                    ...
                                    <div>
                                        <span class="font-small text-muted">By <a href="{{ route ('singleVendor' , ['vendeur_id'=>1]) }}">Progresso</a></span>
                                    </div>
                                    <div class="product-card-bottom">
                                        <div class="product-price">
                                            <span>$12.85</span>
                        ...
                        <div class="product-cart-wrap style-2">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="deals-content">
                                    ...
                                    <div>
                                        <span class="font-small text-muted">By <a href="{{ route ('singleVendor' , ['vendeur_id'=>1]) }}">Yoplait</a></span>
                                    </div>
                                    <div class="product-card-bottom">
                                        <div class="product-price">
                                            <span>$15.85</span>
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div class="sidebar-widget widget-store-info mb-30 bg-3 border-0">
                <div class="vendor-logo mb-30">
                    <img src="{{ asset ('imgs/vendor/vendor-16.png') }}" alt="" />
                </div>
                <div class="vendor-info">
                    <div class="product-category">
                        <span class="text-muted">Since 2012</span>
                    </div>
                    <h4 class="mb-5"><a href="{{ route ('singleVendor' , ['vendeur_id'=>1]) }}" class="text-heading">Nest Food.,Ltd</a></h4>
                    ...
                    <div class="follow-social mb-20">
                        ...
                        <ul class="social-network">
                            <li class="hover-up">
                                <a href="#">
                                    <img src="{{ asset ('imgs/theme/icons/social-tw.svg') }}" alt="" />
                                </a>
                            </li>
                            <li class="hover-up">
                                <a href="#">
                                    <img src="{{ asset ('imgs/theme/icons/social-fb.svg') }}" alt="" />
                                </a>
                            </li>
                            <li class="hover-up">
                                <a href="#">
                                    <img src="{{ asset ('imgs/theme/icons/social-insta.svg') }}" alt="" />
                                </a>
                            </li>
                            <li class="hover-up">
                                <a href="#">
                                    <img src="{{ asset ('imgs/theme/icons/social-pin.svg') }}" alt="" />
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="vendor-info">
                        <ul class="font-sm mb-20">
                            <li><img class="mr-5" src="{{ asset ('imgs/theme/icons/icon-location.svg') }}" alt="" /><strong>Address: </strong> <span>5171 W Campbell Ave undefined, Utah 53127 United States</span></li>
                            <li><img class="mr-5" src="{{ asset ('imgs/theme/icons/icon-contact.svg') }}" alt="" /><strong>Call Us:</strong><span>(+91) - 540-025-124553</span></li>
                        </ul>
                        <a href="{{ route ('singleVendor' , ['vendeur_id'=>1]) }}" class="btn btn-xs">Contact Seller <i class="fi-rs-arrow-small-right"></i></a>
                    </div>
                </div>
            </div>
